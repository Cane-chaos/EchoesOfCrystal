...
void StateStack::popState() {
    m_pendingList.push_back(PendingChange{Pop, StateID::Menu}); // StateID doesn't matter for Pop
}

void StateStack::clearStates() {
    m_pendingList.push_back(PendingChange{Clear, StateID::Menu}); // StateID doesn't matter for Clear
}
